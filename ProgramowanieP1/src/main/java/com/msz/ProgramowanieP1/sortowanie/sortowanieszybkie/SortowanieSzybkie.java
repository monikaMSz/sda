package com.msz.ProgramowanieP1.sortowanie.sortowanieszybkie;
...
public class SortowanieSzybkie implements Sortowanie {
    ...
    private AlgorytmSzybkiWyniki sortujRekurencyjnie(List<Integer> lista) {
        ...
        AlgorytmSzybkiWyniki wynikSrodek = sortujRekurencyjnie(srodek);
        ...
        wyniki.addAll(wynikSrodek.getSrodek());
